...
export const LISTING_COLUMNS_INIT: ITableColumnHeader[] = [
  {
    name: 'selection',
...
export const RESET_FILTER_ARCHIVE: IFilterToggleItems = {
  selectedProduct: '',
  selectedClaim: '',
  selectedSupplier: '',
  quantityFrom: '',
...
export const INIT_FILTERS_ARCHIVE: IFilterParams = {
