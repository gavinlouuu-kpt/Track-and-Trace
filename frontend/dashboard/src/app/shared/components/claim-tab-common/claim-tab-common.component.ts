...
import { CompanyProfileService } from 'src/app/feature/company-profile';
import { UtilService } from '../../service';
import { GlobalStoreService } from '../../store';
import { ClaimPopupCommonComponent } from '../claim-popup-common/claim-popup-common.component';

@Component({
  selector: 'app-claim-tab-common',
  standalone: true,
  imports: [CommonModule, MatIconModule, LoaderComponent, TranslateModule],
  templateUrl: './claim-tab-common.component.html',
  styleUrls: ['./claim-tab-common.component.scss'],
})
export class ClaimTabCommonComponent implements OnInit, OnDestroy {
  @Input() nodeId: any;
