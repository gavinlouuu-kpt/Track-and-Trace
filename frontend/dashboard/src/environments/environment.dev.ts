...
export const environment = {
  ...
  adminUrl: 'https://admin-dev.fairfood.nl/',
  ...
  clientId,
  clientSecret,
  authenticateUrl: `https://login-dev.fairfood.org/sso-authorization?redirect_uri=https://trace-dev.fairfood.nl/&client_id=${clientId}&response_type=code&client_secret=${clientSecret}&app_type=Trace`,
};
